...
class ForceSensor:
    ...
    def measure_value(self):
        left_front_value = self.ADC.readADC(self.LEFT_FRONT_PIN)
        left_back_value = self.ADC.readADC(self.LEFT_BACK_PIN)
        right_front_value = self.ADC.readADC(self.RIGHT_FRONT_PIN)
        rigth_back_value = self.ADC.readADC(self.RIGHT_BACK_PIN)
